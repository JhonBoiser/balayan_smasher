                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('specifications') is-invalid @enderror"
                                  ...
                                  name="specifications"
                                  rows="3"
                                  placeholder="Weight: 88g, Flex: Stiff, Balance: Head Heavy...">{{ old('specifications') }}</textarea>
            ...
            reader.onload = function(e) {
                ...
                col.innerHTML = `
                    <div class="position-relative">
                        ...
                        ${i === 0 ? '<span class="badge bg-primary position-absolute top-0 start-0 m-1">Primary</span>' : ''}
                    </div>
                `;
